                ...
                <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-4">
                  ...
                  <div className="flex shrink-0 -space-x-3 -ml-px">
                    <a className="block" href={"/"}>
                      <Image className="rounded-full border-2 border-slate-100 box-content" src={UserImage08} width="32" height="32" alt="User 08" />
                    </a>
                    <a className="block" href={"/"}>
                      <Image className="rounded-full border-2 border-slate-100 box-content" src={UserImage07} width="32" height="32" alt="User 07" />
                    </a>
                    <a className="block" href={"/"}>
                      <Image className="rounded-full border-2 border-slate-100 box-content" src={UserImage05} width="32" height="32" alt="User 05" />
                    </a>
                    ...
                    <div className="bg-white shadow-lg rounded-sm border border-slate-200 p-4" draggable="true">
                      <div className="sm:flex sm:justify-between sm:items-start">
                        ...
                        <div className="flex items-center justify-end space-x-3">
                          ...
                          <div className="flex shrink-0 -space-x-3 -ml-px">
                            <a className="block" href={"/"}>
                              <Image className="rounded-full border-2 border-white box-content" src={UserImage07} width="24" height="24" alt="User 07" />
                            </a>
                            <a className="block" href={"/"}>
                              <Image className="rounded-full border-2 border-white box-content" src={UserImage05} width="24" height="24" alt="User 05" />
                            </a>
                          </div>
                          {/* Like button */}
                    ...
                    <div className="bg-white shadow-lg rounded-sm border border-slate-200 p-4" draggable="true">
                      <div className="sm:flex sm:justify-between sm:items-start">
                        ...
                        <div className="flex items-center justify-end space-x-3">
                          ...
                          <div className="flex shrink-0 -space-x-3 -ml-px">
                            <a className="block" href={"/"}>
                              <Image className="rounded-full border-2 border-white box-content" src={UserImage08} width="24" height="24" alt="User 08" />
                            </a>
                            <a className="block" href={"/"}>
                              <Image className="rounded-full border-2 border-white box-content" src={UserImage07} width="24" height="24" alt="User 07" />
                            </a>
