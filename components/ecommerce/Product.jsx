        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
              ...
              <div>
                <div className="mb-3">
                  <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href={"/"}>&lt;- Back To Listing</a>
                </div>
                ...
                <div className="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0 mb-6">
                  ...
                  <div className="flex items-center sm:mr-4">
                    ...
                    <a className="block text-sm font-semibold text-slate-800 whitespace-nowrap" href={"/"}>
                      Simona Lürwer
                    </a>
                  </div>
                  {/* Right side */}
                ...
                <div>
                  ...
                  <ul className="space-y-8 sm:space-y-5 my-6">
                    ...
                    <li className="sm:flex items-center">
                      <a className="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href={"/"}>
              ...
              <div>
                <div className="bg-white p-5 shadow-lg rounded-sm border border-slate-200 lg:w-72 xl:w-80">
                  ...
                  <div className="mb-4">
                    <a className="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white" href={"/"}>Buy Now - $69.00</a>
                  </div>
                  <div className="text-xs text-slate-500 italic text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do <a className="underline hover:no-underline" href={"/"}>Terms</a>.</div>
                </div>
              </div>
