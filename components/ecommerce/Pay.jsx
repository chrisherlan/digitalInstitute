      ...
      <header className="bg-white border-b border-slate-200">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 -mb-px">
            ...
            <Link className="block rounded-full bg-slate-100 text-slate-500 hover:text-slate-600" href="/ecommerce/cart">
          ...
          <div className="bg-white px-8 pb-6 rounded-b shadow-lg">
            ...
            {card &&
              <div>
                ...
                <div className="mt-6">
                  <div className="mb-4">
                    <button className="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white" href={"/"}>Pay $253.00</button>
                  </div>
            ...
            {!card &&
              <div>
                <div>
                  <div className="mb-4">
                    <button className="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white" href={"/"}>Pay with PayPal - $253.00</button>
                  </div>
                  <div className="text-xs text-slate-500 italic text-center">You'll be charged $253, including $48 htmlFor VAT in Italy</div>
                </div>
              </div>
