              ...
              <div className="space-y-8 mt-8 mb-80">
                ...
                <div>
                  ...
                  <DropdownEditMenu className="relative inline-flex">
                    <li>
                      <a className="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" href={"/"}>Option 1</a>
                    </li>
                    <li>
                      <a className="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" href={"/"}>Option 2</a>
                    </li>
                    <li>
                      <a className="font-medium text-sm text-rose-500 hover:text-rose-600 flex py-1 px-3" href={"/"}>Remove</a>
                    </li>
                  </DropdownEditMenu>
                </div>
