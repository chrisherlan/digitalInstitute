        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
              ...
              <div>
                <div className="mb-6">
                  <Link className="btn-sm px-3 bg-white border-slate-200 hover:border-slate-300 text-slate-600" href="/job/job-listing">
                ...
                <div className="mb-6">
                  <div className="flex flex-wrap items-center -m-1">
                    <div className="m-1">
                      <a className="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1" href={"/"}>
                        Full-time
                      </a>
                    </div>
                    <div className="m-1">
