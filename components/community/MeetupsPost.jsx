        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
              ...
              <div>
                <div className="mb-6">
                  <Link className="btn-sm px-3 bg-white border-slate-200 hover:border-slate-300 text-slate-600" href="/community/meetups">
                ...
                <div>
                  ...
                  <ul className="space-y-5 my-6">
                    ...
                    <li className="flex items-start">
                      <a className="block mr-3 shrink-0" href={"/"}>
                ...
                <div>
                  ...
                  <div className="space-y-8 sm:space-y-5 my-6 lg:mb-0">
                    ...
                    <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
                      {/* Image */}
                      <a className="relative block w-24 sm:w-56 lg:sidebar-expanded:w-20 xl:sidebar-expanded:w-56 shrink-0" href={"/"}>
                        <Image
                      ...
                      <div className="grow p-5 flex flex-col">
                        <div className='grow'>
                          ...
                          <a className="inline-flex mb-2" href={"/"}>
                        ...
                        <div className="flex justify-between mt-3">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="flex -space-x-3 -ml-0.5">
                              <Image className="rounded-full border-2 border-white box-content" src={Avatar02} width="28" height="28" alt="User 02" />
                              <Image className="rounded-full border-2 border-white box-content" src={Avatar03} width="28" height="28" alt="User 03" />
                              <Image className="rounded-full border-2 border-white box-content" src={Avatar04} width="28" height="28" alt="User 04" />
                            </div>
