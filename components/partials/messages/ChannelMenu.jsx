...
function ChannelMenu() {
  ...
  return (
    <div className="relative">
      ...
      >
        <Image className="w-8 h-8 rounded-full mr-2" src={ChannelImage} width="32" height="32" alt="Group 01" />
        ...
        >
            ...
            <a className="font-medium text-sm text-slate-600 hover:text-slate-800 block py-1.5 px-3" href={"/"} onClick={() => setDropdownOpen(false)}>
              <div className="flex items-center justify-between">
                <div className="grow flex items-center truncate">
                  <Image className="w-7 h-7 rounded-full mr-2" src={ChannelImage01} width="28" height="28" alt="Channel 01" />
          ...
          <li>
            <a className="font-medium text-sm text-slate-600 hover:text-slate-800 block py-1.5 px-3" href={"/"} onClick={() => setDropdownOpen(false)}>
              <div className="flex items-center justify-between">
                <div className="grow flex items-center truncate">
                  <Image className="w-7 h-7 rounded-full mr-2" src={ChannelImage02} width="28" height="28" alt="Channel 02" />
          ...
          <li>
            <a className="font-medium text-sm text-slate-600 hover:text-slate-800 block py-1.5 px-3" href={"/"} onClick={() => setDropdownOpen(false)}>
              <div className="flex items-center justify-between">
                <div className="grow flex items-center truncate">
                  <Image className="w-7 h-7 rounded-full mr-2" src={ChannelImage03} width="28" height="28" alt="Channel 03" />
