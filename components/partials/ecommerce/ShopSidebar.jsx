        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-1 gap-6">
          ...
          <div>
            ...
            <ul className="text-sm font-medium space-y-2">
              ...
              <li>
                <a className="text-slate-600 hover:text-slate-700" href={"/"}>Apps / Software</a>
              </li>
              <li>
                <a className="text-slate-600 hover:text-slate-700" href={"/"}>Design / Tech Products</a>
              </li>
              <li>
                <a className="text-slate-600 hover:text-slate-700" href={"/"}>Books & Writing</a>
              </li>
              <li>
                <a className="text-slate-600 hover:text-slate-700" href={"/"}>Education</a>
              </li>
              <li>
                <a className="text-slate-600 hover:text-slate-700" href={"/"}>Drawing / Painting</a>
              </li>
            </ul>
          </div>
          {/* Price Range */}
