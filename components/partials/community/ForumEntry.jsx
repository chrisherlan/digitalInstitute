      ...
      <div className="mb-2">
        <ul className="inline-flex flex-wrap text-sm font-medium">
          <li className="flex items-center">
            <Link className="text-slate-500 hover:text-indigo-500" href="/community/forum">
              Home
            </Link>
          ...
          <li className="flex items-center">
            <a className="text-slate-500 hover:text-indigo-500" href={"/"}>
              Discussion
            </a>
          </li>
        </ul>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <div className="flex flex-wrap text-xs">
                  ...
                  <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                    <a className="font-medium text-slate-500 hover:text-slate-600" href={"/"}>
                      Reply
                    </a>
                  </div>
                  <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
