      ...
      <div className="flex flex-col h-full">
        ...
        <div className="grow p-5">
          <div className="flex justify-between items-start">
            ...
            <EditMenu align="right" className="relative inline-flex shrink-0">
              <li>
                <Link className="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" href={"/"}>Option 1</Link>
              </li>
              <li>
                <Link className="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" href={"/"}>Option 2</Link>
              </li>
              <li>
                <Link className="font-medium text-sm text-rose-500 hover:text-rose-600 flex py-1 px-3" href={"/"}>Remove</Link>
              </li>
            </EditMenu>
          </div>
          {/* Bio */}
        ...
        <div className="border-t border-slate-200">
          <div className="flex divide-x divide-slate-200r">
            <Link className="block flex-1 text-center text-sm text-indigo-500 hover:text-indigo-600 font-medium px-3 py-4" href="/messages">
            ...
            <Link className="block flex-1 text-center text-sm text-slate-600 hover:text-slate-800 font-medium px-3 py-4 group" href="/settings">
              <div className="flex items-center justify-center">
