      ...
      <div className="bg-white shadow-md rounded border border-slate-200 p-5">
        ...
        <header className="flex justify-between items-start space-x-3 mb-3">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <div className="leading-tight">
                <a className="text-sm font-semibold text-slate-800" href={"/"}>
                  Dominik Lamakani
                </a>
              </div>
          ...
          <EditMenu align="right" className="relative inline-flex shrink-0">
            <li>
              <Link className="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" href={"/"}>
                Option 1
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link className="font-medium text-sm text-rose-500 hover:text-rose-600 flex py-1 px-3" href={"/"}>
                Remove
              </Link>
            </li>
          </EditMenu>
          ...
          <div className="relative !my-4">
            ...
            <div className="absolute left-0 right-0 bottom-0 p-4 bg-black bg-opacity-25 backdrop-blur-md">
              <div className="flex items-center justify-between">
                ...
                <a className="text-xs font-medium text-indigo-400 hover:text-indigo-300" href={"/"}>
                  Learn More -&gt;
                </a>
              </div>
            </div>
