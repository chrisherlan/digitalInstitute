  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-slate-200 p-4">
      ...
      <div className="mb-3">
        ...
        {/* Content */}
        <div>
          <div className="text-sm">#7764 created by <a className="font-medium text-slate-800 hover:underline" href={"/"}>markus-james</a></div>
        </div>
      </div>
      {/* Footer */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex shrink-0 -space-x-3 -ml-px">
          <a className="block" href={"/"}>
            <Image className="rounded-full border-2 border-white box-content" src={UserImage01} width="28" height="28" alt="User 07" />
          </a>
          <a className="block" href={"/"}>
            <Image className="rounded-full border-2 border-white box-content" src={UserImage02} width="28" height="28" alt="User 11" />
          </a>
        </div>
        {/* Right side */}
