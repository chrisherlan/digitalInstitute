  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-slate-200 p-4">
      ...
      <div className="mb-3">
        ...
        <div className="flex items-center mb-2">
          <div className="flex shrink-0 -space-x-3 -ml-px mr-2">
            <a className="block" href={"/"}>
              <Image className="rounded-full border-2 border-white box-content" src={UserImage01} width="28" height="28" alt="User 12" />
            </a>
          </div>
          <div className="grow">
            <a className="inline-flex text-slate-800 hover:text-slate-900" href={"/"}>
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Dedicated form for a category of users that will perform actions? <a className="font-medium text-indigo-500 hover:text-indigo-600" href={"/"}>#viewall</a></div>
        </div>
      </div>
      {/* Footer */}
