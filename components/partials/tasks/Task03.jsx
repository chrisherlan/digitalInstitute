      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex shrink-0 -space-x-3 -ml-px">
          <a className="block" href={"/"}>
            <Image className="rounded-full border-2 border-white box-content" src={UserImage01} width="28" height="28" alt="User 03" />
          </a>
          <a className="block" href={"/"}>
            <Image className="rounded-full border-2 border-white box-content" src={UserImage02} width="28" height="28" alt="User 10" />
          </a>
        </div>
        {/* Right side */}
