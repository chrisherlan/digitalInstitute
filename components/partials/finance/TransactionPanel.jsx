...
import Image04 from '../../images/transactions-image-04.svg';
            ...
            <div className="drop-shadow-lg mt-12">
              ...
              <div className="bg-white rounded-t-xl px-5 pb-2.5 text-center">
                <div className="mb-3 text-center">
                  <Image className="inline-flex w-12 h-12 rounded-full -mt-6" src={Image04} width="48" height="48" alt="Transaction 04" />
                </div>
