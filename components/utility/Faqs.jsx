            ...
            <div className="max-w-3xl m-auto">
              ...
              <div className="mb-8 border-b border-slate-200">
                <ul className="text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
                  <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                    <a className="text-indigo-500 whitespace-nowrap" href={"/"}>Popular</a>
                  </li>
                  <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                    <a className="text-slate-500 hover:text-slate-600 whitespace-nowrap" href={"/"}>Accessibility</a>
                  </li>
                  <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                    <a className="text-slate-500 hover:text-slate-600 whitespace-nowrap" href={"/"}>Marketing</a>
                  </li>
                  <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                    <a className="text-slate-500 hover:text-slate-600 whitespace-nowrap" href={"/"}>Development</a>
                  </li>
                  <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                    <a className="text-slate-500 hover:text-slate-600 whitespace-nowrap" href={"/"}>Account</a>
                  </li>
                </ul>
              </div>
              ...
              <div>
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href={"/"}>General</a>
                      </li>
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href={"/"}>Marketing</a>
                      </li>
                    </ul>
                  </div>
                </article>
                ...
                <article className="py-4 border-b border-slate-200">
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href={"/"}>Development</a>
                      </li>
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href={"/"}>Acessibility</a>
                      </li>
                    </ul>
                  </div>
                </article>
                ...
                <article className="py-4 border-b border-slate-200">
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      ...
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href={"/"}>Plans</a>
                      </li>
                    </ul>
                  </div>
                </article>
                ...
                <article className="py-4 border-b border-slate-200">
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      ...
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href={"/"}>Account</a>
                      </li>
                    </ul>
                  </div>
                </article>
                ...
                <article className="py-4 border-b border-slate-200">
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      ...
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href={"/"}>Accessibility</a>
                      </li>
                    </ul>
                  </div>
                </article>
              ...
              <div className="mt-6">
                <div className="flex justify-end">
                  <a className="btn bg-white border-slate-200 hover:border-slate-300 text-indigo-500" href={"/"}>See All Questions -&gt;</a>
                </div>
              </div>
