                          ...
                          <div className="flex flex-nowrap items-center space-x-2 mb-6">
                            ...
                            <div className="flex shrink-0 -space-x-3 -ml-px">
                              <a className="block" href={"/"}>
                                <Image className="rounded-full border-2 border-white box-content" src={User05} width="28" height="28" alt="User 05" />
                              </a>
                              <a className="block" href={"/"}>
                                <Image className="rounded-full border-2 border-white box-content" src={User08} width="28" height="28" alt="User 08" />
                              </a>
                              <a className="block" href={"/"}>
                                <Image className="rounded-full border-2 border-white box-content" src={User09} width="28" height="28" alt="User 09" />
                              </a>
                              <a className="block" href={"/"}>
                      ...
                      <div className="grow pb-6 border-b border-slate-200">
                        <header>
                          <div className="flex flex-nowrap items-center space-x-2 mb-6">
                            ...
                            <div className="flex shrink-0 -space-x-3 -ml-px">
                              <a className="block" href={"/"}>
                                <Image className="rounded-full border-2 border-white box-content" src={User03} width="28" height="28" alt="User 03" />
                              </a>
                              <a className="block" href={"/"}>
                                <Image className="rounded-full border-2 border-white box-content" src={User05} width="28" height="28" alt="User 05" />
                              </a>
                      ...
                      <div className="grow pb-6 border-b border-slate-200">
                        <header>
                          <div className="flex flex-nowrap items-center space-x-2 mb-6">
                            ...
                            <div className="flex shrink-0 -space-x-3 -ml-px">
                              <a className="block" href={"/"}>
                                <Image className="rounded-full border-2 border-white box-content" src={User06} width="28" height="28" alt="User 03" />
                              </a>
                              <a className="block" href={"/"}>
                                <Image className="rounded-full border-2 border-white box-content" src={User05} width="28" height="28" alt="User 05" />
                              </a>
